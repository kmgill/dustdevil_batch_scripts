...
if [ `ls *NCAM00556*-rjcal.png 2> /dev/null | wc -l` -gt 0 ]; then
    diffgif -i *NCAM00556*-rjcal.png -o CloudShadow_${sol}.gif -v -b 0 -w 1.0 -g 2.5 -B 1.5 -d 20
fi

if [ `ls *NCAM00551*-rjcal.png 2> /dev/null | wc -l` -gt 0 ]; then
    diffgif -i *NCAM00551*-rjcal.png -o ZenithMovie_${sol}.gif -v -b 0 -w 1.0 -g 2.5 -B 1.5 -d 20
fi

if [ `ls *NCAM00536*-rjcal.png 2> /dev/null | wc -l` -gt 0 ]; then
    diffgif -i *NCAM00536*-rjcal.png -o ZenithMovie_${sol}.gif -v -b 0 -w 1.0 -g 2.5 -B 1.5 -d 20
fi

if [ `ls *NCAM00567*-rjcal.png 2> /dev/null | wc -l` -gt 0 ]; then
    diffgif -i *NCAM00567*-rjcal.png -o SupraHorizonMovie_${sol}.gif -v -b 0 -w 1.0 -g 2.5 -B 1.5 -d 20
fi

if [ `ls *NCAM00596*-rjcal.png 2> /dev/null | wc -l` -gt 0 ]; then
    diffgif -i *_S*NCAM00596*rjcal.png -o DustDevil596_${sol}.gif -v -b 0 -w 5.0 -g 1.5 -B 1.5 -d 40
fi
